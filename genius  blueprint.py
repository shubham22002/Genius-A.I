...
def Wolf():
    api_key = ""                                  # get api key from wolframalpha website and paste in " ".
...
while True:
    ...
    if 'retype' in query:                            # speak retype to clear the text from serachbox and say what you want to search
        pyautogui.press('/')
    ...
    if 'close' in query:                           # speak to close the app (eg."C:\Program Files\Google\Chrome\Application\chrome.exe"-speak only chrome)
